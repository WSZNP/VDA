...
; (function () {
    ...
    // let a = document.querySelectorAll('.bar a')
            ...
            series: [
                {
                    ...
                    itemStyle: {
                        ...
                        color: function (params) {
                            // console.log(params)
                            return myColor[params.dataIndex]//params里面是柱子对象，dataIndex是当前柱子的索引号
                        }
                    },
                    // 柱子之间的距离
                    barCategoryGap: 50,
    ...
    ; (function () {
        let yearData = [
            ...
            },
            {
                year: '2022',  // 年份
                data: [
                    { value: 1068, name: '10岁以下' },
                    { value: 935, name: '20-29岁' },
                    { value: 480, name: '30-39岁' },
                    { value: 684, name: '40-49岁' },
                    { value: 500, name: '50岁以上' }
                ]
            }
        ]
        ...
        let a = document.querySelectorAll('.pie a')
        a.forEach(function (item, index) {
            a[index].addEventListener('click', function () {
                // console.log(index)
                let obj = yearData[index]
